  ...
  render() {
    ...
    return (
      <div>
        <Head>
          <title>
            {this.props.post.blog_detail
              ? this.props.post.blog_detail.SEOTitle
              : ""}
          </title>
          <meta
            name="description"
            content={
              this.props.post.blog_detail
                ? this.props.post.blog_detail.SEODescription
                : ""
            }
          />
          <meta
            ...
            content={
              this.props.post.blog_detail
                ? this.props.post.blog_detail.SEOKeywords
                : ""
            }
          />
          <meta
                  ...
                  <div className="section-flex">
                    <div className="sf-item image-z-negetive">
                      <div className="fb-image">
                        <img
                          src={`${baseUrl}${
                            data.blogCardImage ? data.blogCardImage.url : ""
                          }`}
                          alt="blog-cover"
                        />
                      </div>
