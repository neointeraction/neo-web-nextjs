        ...
        <div>
          <ImageVideoText
            ...
            contentText={
              <div>
                <p>
                  UI Engineering at Neointeraction Design has evolved from a
                  strong belief that a well-done design is not worth if not
                  carefully crafted to life. UI engineering plays a key role in
                  most of the modern web applications that drive reusable
                  component-driven approaches with React Js/Angular/VUE.js.
                </p>
                <ul className="solution-list mb-3">
                  <li>Working prototype to get early feedback from users</li>
                  <li>Clean code which can be directly plugged with APIs</li>
