                ...
                <div className="row">
                  <div className="col-md-6">
                    ...
                    <ul className="solution-list ux-pop-title mb-20p">
                      <li>
                        Gather information about users and step into their shoes
                      ...
                      <li>
                        Develop a flow, a plan, and break down the various user
                        journeys that are required to achieve the best possible
                        experience.
                      </li>
                      <li>
                        Communicate and collaborate with stakeholders and
                        internal teams to help them understand design concepts
                      </li>
                      <li>
                        Have a good eye for detail and always try to simplify a
                        user’s experience.
                      </li>
                    </ul>
                    <p className="ux-sub-text">Skills</p>
                    <ul className="solution-list ux-pop-title">
                      <li>Understanding of UX principles and methodologies.</li>
                      <li>Ability to take feedback and design inputs.</li>
                      <li>
                        Skilled at rapid prototyping, UX research, developing
                        wireframes, creating product mock-ups, analyzing
                        business processes.
                      </li>
                      <li>
                        Understanding of Web and mobile Ux best practices.
                      </li>
                      <li>
                        Experience in prototyping - Axure, Sketch, Figma, Adobe
                        XD, Marvel App.
                      </li>
                      <li>
                        Degree in any Design discipline (Interaction Design
                        preferred)
                      </li>
                    </ul>
                  </div>
