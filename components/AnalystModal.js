                ...
                <div className="row">
                  <div className="col-md-6">
                    <h1 className="main-title animated text-left fadeIn pop-title">
                      Applying for an Business Analyst
                    </h1>
                    ...
                    <ul className="solution-list ux-pop-title mb-20p">
                      <li>
                        Help design and build custom-designed solutions that use
                        a wide range of the latest technologies.
                      </li>
                      <li>Evangelize Scrum Development best practices.</li>
                      <li>
                        Work closely with the lead architects and product owners
                        to develop assessments and project plans.
                      </li>
                      <li>
                        Represent the organization in client meetings, document
                        meeting outcomes, and coordinate all internal and
                        external follow-ups to close issues in support of the
                        project requirements.
                      </li>
                      <li>
                        Collaborate with system architect and development leads
                        to document all software changes necessary to meet the
                        requirements project request.
                      </li>
                      <li>
                        Assist product owners in sprint planning and daily
                        scrums.
                      </li>
                    </ul>
                    ...
                    <ul className="solution-list ux-pop-title">
                      <li>
                        Knowledge of full System Development Life Cycle (SDLC)
                        with an understanding of a variety of technologies and
                        platforms such as web, client/server, database concepts,
                        and object-oriented programming.
                      </li>
                      <li>
                        Experience with modeling business processes using a
                        variety of tools and techniques.
                      </li>
                      <li>Experience with Scrum-based product development.</li>
                      <li>Good technical and analytic skills.</li>
                    </ul>
                  </div>
                  <div className="col-md-6">
