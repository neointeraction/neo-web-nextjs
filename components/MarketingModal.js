                ...
                <div className="row">
                  <div className="col-md-6">
                    <h1 className="main-title animated text-left fadeIn pop-title">
                      Applying for an digital marketing specialist
                    </h1>
                    <ul className="apply-info">
                      <li>
                        <strong> Position</strong> : Digital Marketing
                        Specialist
                      </li>
                      <li>
                    ...
                    <ul className="solution-list ux-pop-title mb-20p">
                      <li>
                        Drive more visitors to the corporate brand website using
                        various content marketing strategies.
                      </li>
                      <li>
                        Write blog articles to drive traffic to the website.
                      </li>
                      <li>
                        Generate leads using various social channels, industry
                        research etc.
                      </li>
                      <li>
                        Prepare pitch decks for various services that we offer.
                      </li>
                      <li>
                      ...
                      <li>
                        Utilize the strong analytical ability to evaluate
                        end-to-end customer experience across multiple channels
                    ...
                    <ul className="solution-list ux-pop-title">
                      <li>
                        Proven experience in leading and managing SEO/SEM,
                        marketing database, email, social media, and/or display
                        advertising campaigns.
                      </li>
                      <li>
                        Good knowledge of website analytics tools (e.g., Google
                      ...
                      <li>
                        Ability to include a fun/quirky factor in any type of
                        marketing campaign to grab the attention of a
                        customer/user.
                      </li>
                    </ul>
                  </div>
